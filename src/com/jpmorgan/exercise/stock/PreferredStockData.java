...
/**
 * Immutable bean to hold information on preferred stocks.
 * 
...
public class PreferredStockData extends StockData {
	...
	public PreferredStockData(String stockIdentifier, double lastDividend, double parValue, double fixedDividend) {
		super(stockIdentifier, lastDividend, parValue);
		this.fixedDividend = fixedDividend;
	}

	@Override
	public double calculateDividendYield(double price) throws InvalidParameterException {
		if (price <= 0) {
